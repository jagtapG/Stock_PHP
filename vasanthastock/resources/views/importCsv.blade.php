        ...
        <div class="col-lg-12">
            <section class="box ">
                <header class="panel_header">
                    <h2 style="text-align: center;font-size:23px;">Import CSV File</h2>
                ...
                <div class="content-body">    
                	<div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                        	<form action="{{url('product-import')}}" method="post" enctype="multipart/form-data" name="csvFile" onsubmit=" return csvFunction()" id="modalForm">
                                {{csrf_field()}} 
                                <div class="col-md-12">
                                    <div class="col-md-10">
