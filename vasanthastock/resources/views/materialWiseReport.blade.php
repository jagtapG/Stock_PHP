                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <table id="example" class="table table-striped dt-responsive display" cellspacing="0" width="100%">
                                ...
                                <tbody>
                                    @foreach($matWiseReports as $matWiseReport)
									<tr>
										<td><a href="matWiseReport/{{$matWiseReport->material_id}}">{{$matWiseReport->material_id}}</a></td>
										<td>{{$matWiseReport->material_name}}</td>
                                        <td>{{$matWiseReport->material_group}}</td>
									</tr>
									@endforeach
                                </tbody>
                            </table>
