        ...
        <div class="col-lg-12">
            <section class="box ">
                <header class="panel_header">
                    <h2 style="text-align: center;font-size:23px;">Added Stock Report</h2>
                            ...
                            <table id="example" class="table table-striped dt-responsive display" cellspacing="0" width="100%">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{$report->mat_name}}</td>
                                        <td>{{$report->material}}</td>
                                        <td>{{$report->prvstock}}</td>
                                        <td>{{$report->newaddstock}}</td>
                                    </tr>
                                    @endforeach
                                </tbody>
                            </table>
